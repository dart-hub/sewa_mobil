        ...
        <div class="bg-white shadow sm:rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="text-lg leading-6 font-medium text-gray-900">Edit Stok</h3>
                ...
                <form action="{{ route('stoks.update', $stok) }}" method="POST" class="mt-5">
                    @csrf
                    @method('PUT')
                        ...
                        <div>
                            ...
                            >
                                ...
                                @foreach($mobils as $mobil)
                                    <option value="{{ $mobil->id }}" {{ old('mobil_id', $stok->mobil_id) == $mobil->id ? 'selected' : '' }}>
