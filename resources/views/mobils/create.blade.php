        ...
        <div class="bg-white shadow sm:rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="text-lg leading-6 font-medium text-gray-900">Tambah Mobil Baru</h3>
                ...
                <form action="{{ route('mobils.store') }}" method="POST" class="mt-5">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="reguler" {{ old('car_type') == 'reguler' ? 'selected' : '' }}>Reguler</option>
                                <option value="premium" {{ old('car_type') == 'premium' ? 'selected' : '' }}>Premium</option>
                            </select>
                            @error('car_type')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="mt-8 flex items-center justify-end gap-x-3">
                        ...
                        >
                            <i class="fas fa-save mr-1"></i> Simpan Mobil
                        </button>
                    </div>
                </form>
            </div>
