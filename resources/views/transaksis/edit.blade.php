    ...
    <div class="px-4 py-6 sm:px-0">
        <div class="bg-white shadow sm:rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                ...
                <form action="{{ route('transaksis.update', $transaksi) }}" method="POST" class="mt-5">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input 
                                        ...
                                        id="customer_name" 
                                        name="customer_name" 
                                        value="{{ old('customer_name', $transaksi->customer->name) }}" 
                                ...
                                <div>
                                    ...
                                    <input 
                                        ...
                                        id="customer_phone" 
                                        name="customer_phone" 
                                        value="{{ old('customer_phone', $transaksi->customer->phone_number) }}" 
                        ...
                        <div class="bg-green-50 p-4 rounded-md border border-green-200">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    @foreach($mobils as $mobil)
                                        <option value="{{ $mobil->id }}" data-harga="{{ $mobil->price_per_day }}" {{ old('mobil_id', $transaksi->mobil_id) == $mobil->id ? 'selected' : '' }}>
                            ...
                            <div class="mt-4">
                                ...
                                <input 
                                    ...
                                    name="number_of_cars" 
                                    min="1" 
                                    value="{{ old('number_of_cars', $transaksi->number_of_cars) }}" 
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input 
                                        ...
                                        id="rent_date" 
                                        name="rent_date" 
                                        value="{{ old('rent_date', $transaksi->rent_date) }}" 
                                        class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm border p-2"
                                        required
                                    >
                                    @error('rent_date')
                                ...
                                <div>
                                    ...
                                    <input 
                                        ...
                                        id="return_date" 
                                        name="return_date" 
                                        value="{{ old('return_date', $transaksi->return_date) }}" 
                                        class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm border p-2"
                                        required
                                    >
                                    @error('return_date')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    >
                                        ...
                                        <option value="lunas" {{ old('payment_status', $transaksi->payment_status) == 'lunas' ? 'selected' : '' }}>Lunas</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <option value="cash" {{ old('payment_type', $transaksi->payment_type) == 'cash' ? 'selected' : '' }}>Cash</option>
                                        <option value="transfer" {{ old('payment_type', $transaksi->payment_type) == 'transfer' ? 'selected' : '' }}>Transfer</option>
                                    </select>
                                    @error('payment_type')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
